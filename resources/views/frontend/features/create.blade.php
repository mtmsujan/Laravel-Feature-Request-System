        ...
        <form action="{{ route('feedback.store') }}" method="post" class="max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="mb-2 col-span-2">
                    <x-input label="Title" type="text" name="title" placeholder="Title" class="w-full" />
                </div>
                <div class="mb-2 col-span-1">
                    <x-select label="Choose Priority" class="capitalize" name="priority" placeholder="Choose Priority"
                        :items="array_column(\App\Enums\FeaturePriorityEnum::cases(), 'value')">
                    </x-select>
                </div>
                <div class="mb-2 col-span-3">
                    <x-editor placeholder="Body" name="body" cols="30" rows="10"></x-editor>
                </div>
            </div>
